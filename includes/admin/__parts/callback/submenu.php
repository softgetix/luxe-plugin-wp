...
function luxe_mobile_menu_slide_container_sub_font_size_field_callback()
{
    ...
    echo '<input type="number" name="luxe_mobile_menu_slide_container_sub_font_size" value="' . esc_attr($container_submenu_font_size) . '">';
...
function luxe_mobile_menu_slide_container_sub_line_height_callback()
{
    ...
    echo '<input placeholder="" type="number" name="luxe_mobile_menu_slide_container_sub_line_height" value="' .$menu_line_height . '">';
